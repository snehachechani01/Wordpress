...
if( ! defined( 'BDPW_VERSION' ) ) {
	define( 'BDPW_VERSION', '2.4.1' ); // Version of plugin
}
...
if( ! defined( 'BDPW_PLUGIN_LINK_UNLOCK' ) ) {
	define( 'BDPW_PLUGIN_LINK_UNLOCK', 'https://www.essentialplugin.com/wordpress-plugin/blog-designer-post-and-widget/?utm_source=WP&utm_medium=Blog-Designer&utm_campaign=Features-PRO#wpos-epb' ); // Plugin link
}
if( ! defined( 'BDPW_PLUGIN_LINK_UPGRADE' ) ) {
	define( 'BDPW_PLUGIN_LINK_UPGRADE', 'https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=Blog-Designer&utm_campaign=Upgrade-PRO#wpos-epb' ); // Plugin Check link
}
