...
class Bdpw_Admin {
	...
	function bdpw_register_menu() {
		...
		// Setting page
		add_submenu_page( 'bdpw-about', __('Solutions & Features - blog-designer-for-post-and-widget', 'blog-designer-for-post-and-widget'), '<span style="color:#2ECC71">'. __('Solutions & Features', 'blog-designer-for-post-and-widget').'</span>', 'manage_options', 'bdpw-solutions-features', array($this, 'bdpw_solutions_features_page') );
	...
	function bdpw_solutions_features_page() {
		include_once( BDPW_DIR . '/includes/admin/settings/solutions-features.php' );	
	}
