			...
			<div id="post-body-content">
				...
				<div class="meta-box-sortables">
						<div class="postbox">
							<div class="postbox-header">
								<h2 class="hndle">
									<span><?php esc_html_e( 'Need Support & Solutions?', 'blog-designer-for-post-and-widget' ); ?></span>
								</h2>
							</div>
							<div class="inside wpos-clearfix">
								<div class="wpos-col">
									<div class="wpos-box">
										<h5 style="font-size: 18px;line-height: 30px;margin: 10px 0px; background:#0055fb;">Blog Designer Premium Features</h5>
										<h4>Single Plugin</h4>
										<ul class="wpos-list">
											<li><b>130+ predefined template</b> stunning and cool layouts.</li>
											<li><b>8 Shortcodes</b> for Slider, Grid, Grid Box slider and Masonry</li>
											<li>Drag &amp; Drop order change</li>
											<li>Display Blog in a <b>grid view.</b></li>
											<li>Display <b>blog with masonry</b>.</li>
											<li>Display blog in <b>slider view</b></li>
											<li><a href="<?php echo BDPW_PLUGIN_LINK_UPGRADE; ?>" target="_blank">View More All Features</a></li>
										</ul>
										<div style="text-align:center;">
											<a class="button button-primary button-blue" href="<?php echo BDPW_PLUGIN_LINK_UPGRADE; ?>" target="_blank"><?php esc_html_e('Grab Now', 'blog-designer-for-post-and-widget'); ?></a>
										</div>
									</div>
								</div>
								<div class="wpos-col">
									<div class="wpos-box">
										<h5 style="font-size: 18px;line-height: 30px;margin: 10px 0px; background:#ff5d52;">Essential Bundle With Blog Designer</h5>
										<h4>Bundle Deal</h4>
										<ul style="margin: 0;list-style: none;font-size: 16px;">
											<li style="margin-bottom:8px;">
												<span style="display:inline-block;vertical-align: middle;"><img src="<?php echo BDPW_URL; ?>assets/images/utility-50.png" width="24"></span> <span style="display:inline-block;vertical-align: middle;">39 Utility Plugins</span>
											</li>
											<li style="margin-bottom:8px;">
												<span style="display:inline-block;vertical-align: middle;"><img src="<?php echo BDPW_URL; ?>assets/images/SlidersPack-50.png" width="24"></span> <span style="display:inline-block;vertical-align: middle;"> 10 SlidersPack</span>
											</li>
											<li style="margin-bottom:8px;">
												<span style="display:inline-block;vertical-align: middle;"><img src="<?php echo BDPW_URL; ?>assets/images/popup-anything-icon.png" width="24"></span> <span style="display:inline-block;vertical-align: middle;"> Popup Anything A Marketing Popup</span>
											</li>
											<li>
												<span style="display:inline-block;vertical-align: middle;"><img src="<?php echo BDPW_URL; ?>assets/images/security-icon.png" width="24"></span> <span style="display:inline-block;vertical-align: middle;"> Essential Security</span>
											</li>
										</ul>
										<div style="text-align:center;">
											<a class="button button-primary button-orange" href="<?php echo BDPW_PLUGIN_BUNDLE_LINK; ?>" target="_blank"><?php esc_html_e('Grab Now', 'blog-designer-for-post-and-widget'); ?></a>
										</div>
									</div>
								</div>
								<div class="wpos-clearfix">
									<img src="<?php echo BDPW_URL; ?>assets/images/page-builder-support.jpg" style="max-width:100% " />
								</div>
							</div><!-- .inside -->
						</div><!-- #general -->
					</div><!-- .meta-box-sortables -->
				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo esc_url( BDPW_PLUGIN_LINK_UPGRADE ); ?>" target="_blank"><?php esc_html_e('Grab Blog Designer Now', 'blog-designer-for-post-and-widget'); ?></a>
						</div><!-- .inside -->
					</div><!-- #general -->
