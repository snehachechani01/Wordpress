	...
	<div class="bdpw-sf-wrap">
		<div class="bdpw-sf-inr">
			<div class="bdpw-sf-features-section bdpw-sf-team bdpw-sf-center">
				...
				<a href="<?php echo BDPW_PLUGIN_BUNDLE_LINK; ?>" target="_blank" class="bdpw-sf-btn bdpw-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
			</div>
			<div class="bdpw-sf-features-section bdpw-sf-team bdpw-sf-center">					
				...
				<img class="bdpw-sf-image" src="<?php echo BDPW_URL; ?>/assets/images/wpos-team.png" alt="wpos team" />
				<a href="<?php echo BDPW_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="bdpw-sf-btn bdpw-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
			</div>
				...
				<div class="bdpw-sf-welcome-wrap bdpw-sf-center">	
					<div class="bdpw-features-box-wrap">
						<ul class="bdpw-features-box-grid">
							<li>
							<div class="bdpw-popup-icon"><img src="<?php echo BDPW_URL; ?>assets/images/popup-icon/blog-grid.png" /></div>
							Blog Grid View</li>
							<li>
							<div class="bdpw-popup-icon"><img src="<?php echo BDPW_URL; ?>assets/images/popup-icon/blog-grid.png" /></div>
							Recent Blog Grid View</li>
							<li>
							<div class="bdpw-popup-icon"><img src="<?php echo BDPW_URL; ?>assets/images/popup-icon/slider.png" /></div>
							Blog Slider View</li>
							<li>
							<div class="bdpw-popup-icon"><img src="<?php echo BDPW_URL; ?>assets/images/popup-icon/blog-list-view.png" /></div>
							Blog List View</li>
							<li>
							<div class="bdpw-popup-icon"><img src="<?php echo BDPW_URL; ?>assets/images/popup-icon/carousel.png" /></div>
							Blog Ticker View</li>
							<li>
							<div class="bdpw-popup-icon"><img src="<?php echo BDPW_URL; ?>assets/images/popup-icon/grid-box.png" /></div>
							Blog Gridbox View</li>
							<li>
							<div class="bdpw-popup-icon"><img src="<?php echo BDPW_URL; ?>assets/images/popup-icon/grid-box.png" /></div>
							Blog Gridbox Slider View</li>
							<li>
							<div class="bdpw-popup-icon"><img src="<?php echo BDPW_URL; ?>assets/images/popup-icon/blog-masonry.png" /></div>
				...
				<div class="bdpw-testimonial-section-inr">
					<div class="bdpw-testimonial-box-wrap">
						<div class="bdpw-testimonial-box-grid">
							...
							<div class="bdpw-testimonial-rating"><img src="<?php echo BDPW_URL; ?>assets/images/rating.png" /></div>
						</div>
						<div class="bdpw-testimonial-box-grid">
